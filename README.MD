...
The API supports multiple proxy providers:

**Zyte Smart Proxy Manager:**
```env
PROXIES=proxy-hub.scraperapi.com:8001:username:password
```

**Custom Proxy Pool:**
```env
PROXIES=proxy1.com:8080:user1:pass1,proxy2.com:8080:user2:pass2
```
